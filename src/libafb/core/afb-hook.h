...
struct afb_hook_req_itf {
	...
	void (*hook_req_reply)(void *closure, const struct afb_hookid *hookid, const struct afb_req_common *req, struct json_object *obj, const char *error, const char *info);
	...
	void (*hook_req_subcallsync_result)(void *closure, const struct afb_hookid *hookid, const struct afb_req_common *req, int status, struct json_object *object, const char *error, const char *info);
...
extern void afb_hook_req_reply(const struct afb_req_common *req, struct json_object *obj, const char *error, const char *info);
...
extern int afb_hook_req_subcallsync_result(const struct afb_req_common *req, int status, struct json_object *object, const char *error, const char *info);
...
struct afb_hook_api_itf {
	void (*hook_api_event_broadcast_before)(void *closure, const struct afb_hookid *hookid, const struct afb_api_common *comapi, const char *name, struct json_object *object);
	void (*hook_api_event_broadcast_after)(void *closure, const struct afb_hookid *hookid, const struct afb_api_common *comapi, const char *name, struct json_object *object, int result);
	...
	void (*hook_api_callsync_result)(void *closure, const struct afb_hookid *hookid, const struct afb_api_common *comapi, int result, struct json_object *object, const char *error, const char *info);
	...
	void (*hook_api_api_set_verbs_v2)(void *closure, const struct afb_hookid *hookid, const struct afb_api_common *comapi, int result, const struct afb_verb_v2 *verbs);
...
extern void afb_hook_api_event_broadcast_before(const struct afb_api_common *comapi, const char *name, struct json_object *object);
extern int afb_hook_api_event_broadcast_after(const struct afb_api_common *comapi, const char *name, struct json_object *object, int result);
...
extern int afb_hook_api_callsync_result(const struct afb_api_common *comapi, int result, struct json_object *object, const char *error, const char *info);
...
extern int afb_hook_api_api_set_verbs_v2(const struct afb_api_common *comapi, int result, const struct afb_verb_v2 *verbs);
