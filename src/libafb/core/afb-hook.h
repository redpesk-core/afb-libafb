...
struct afb_hook_req_itf {
	...
	void (*hook_req_reply)(void *closure, const struct afb_hookid *hookid, const struct afb_req_common *req, int status, unsigned nparams, const struct afb_data_x4 * const *params);
	...
	void (*hook_req_subcall)(void *closure, const struct afb_hookid *hookid, const struct afb_req_common *req, const char *api, const char *verb, unsigned nparams, const struct afb_data_x4 * const *params);
	void (*hook_req_subcall_result)(void *closure, const struct afb_hookid *hookid, const struct afb_req_common *req, int status, unsigned nreplies, const struct afb_data_x4 * const *replies);
	void (*hook_req_subcallsync)(void *closure, const struct afb_hookid *hookid, const struct afb_req_common *req, const char *api, const char *verb, unsigned nparams, const struct afb_data_x4 * const *params);
	void (*hook_req_subcallsync_result)(void *closure, const struct afb_hookid *hookid, const struct afb_req_common *req, int result, int *status, unsigned *nreplies, const struct afb_data_x4 * const *replies);
...
extern void afb_hook_req_reply(const struct afb_req_common *req, int status, unsigned nparams, const struct afb_data_x4 * const *params);
...
extern void afb_hook_req_subcall(const struct afb_req_common *req, const char *api, const char *verb, unsigned nparams, const struct afb_data_x4 * const *params, int flags);
extern void afb_hook_req_subcall_result(const struct afb_req_common *req, int status, unsigned nreplies, const struct afb_data_x4 * const *replies);
extern void afb_hook_req_subcallsync(const struct afb_req_common *req, const char *api, const char *verb, unsigned nparams, const struct afb_data_x4 * const *params, int flags);
extern int afb_hook_req_subcallsync_result(const struct afb_req_common *req, int result, int *status, unsigned *nreplies, const struct afb_data_x4 * const *replies);
...
struct afb_hook_api_itf {
	void (*hook_api_event_broadcast_before)(void *closure, const struct afb_hookid *hookid, const struct afb_api_common *comapi, const char *name, unsigned nparams, const struct afb_data_x4 * const *params);
	void (*hook_api_event_broadcast_after)(void *closure, const struct afb_hookid *hookid, const struct afb_api_common *comapi, const char *name, unsigned nparams, const struct afb_data_x4 * const *params, int result);
	...
	void (*hook_api_on_event_before)(void *closure, const struct afb_hookid *hookid, const struct afb_api_common *comapi, const char *event, int evt, unsigned nparams, const struct afb_data_x4 * const *params);
	void (*hook_api_on_event_after)(void *closure, const struct afb_hookid *hookid, const struct afb_api_common *comapi, const char *event, int evt, unsigned nparams, const struct afb_data_x4 * const *params);
	void (*hook_api_call)(void *closure, const struct afb_hookid *hookid, const struct afb_api_common *comapi, const char *api, const char *verb, unsigned nparams, const struct afb_data_x4 * const *params);
	void (*hook_api_call_result)(void *closure, const struct afb_hookid *hookid, const struct afb_api_common *comapi, int status, unsigned nreplies, const struct afb_data_x4 * const *replies);
	void (*hook_api_callsync)(void *closure, const struct afb_hookid *hookid, const struct afb_api_common *comapi, const char *api, const char *verb, unsigned nparams, const struct afb_data_x4 * const *params);
	void (*hook_api_callsync_result)(void *closure, const struct afb_hookid *hookid, const struct afb_api_common *comapi, int result, int *status, unsigned *nreplies, const struct afb_data_x4 * const *replies);
	...
	void (*hook_api_on_event_handler_before)(void *closure, const struct afb_hookid *hookid, const struct afb_api_common *comapi, const char *event, int evt, unsigned nparams, const struct afb_data_x4 * const *params, const char *pattern);
	void (*hook_api_on_event_handler_after)(void *closure, const struct afb_hookid *hookid, const struct afb_api_common *comapi, const char *event, int evt, unsigned nparams, const struct afb_data_x4 * const *params, const char *pattern);
...
extern void afb_hook_api_event_broadcast_before(const struct afb_api_common *comapi, const char *name, unsigned nparams, const struct afb_data_x4 * const *params);
extern int afb_hook_api_event_broadcast_after(const struct afb_api_common *comapi, const char *name, unsigned nparams, const struct afb_data_x4 * const *params, int result);
...
extern void afb_hook_api_on_event_before(const struct afb_api_common *comapi, const char *event, int evt, unsigned nparams, const struct afb_data_x4 * const *params);
extern void afb_hook_api_on_event_after(const struct afb_api_common *comapi, const char *event, int evt, unsigned nparams, const struct afb_data_x4 * const *params);
extern void afb_hook_api_call(const struct afb_api_common *comapi, const char *api, const char *verb, unsigned nparams, const struct afb_data_x4 * const *params);
extern void afb_hook_api_call_result(const struct afb_api_common *comapi, int status, unsigned nreplies, const struct afb_data_x4 * const *replies);
extern void afb_hook_api_callsync(const struct afb_api_common *comapi, const char *api, const char *verb, unsigned nparams, const struct afb_data_x4 * const *params);
extern int afb_hook_api_callsync_result(const struct afb_api_common *comapi, int result, int *status, unsigned *nreplies, const struct afb_data_x4 * const *replies);
...
extern void afb_hook_api_on_event_handler_before(const struct afb_api_common *comapi, const char *event, int evt, unsigned nparams, const struct afb_data_x4 * const *params, const char *pattern);
extern void afb_hook_api_on_event_handler_after(const struct afb_api_common *comapi, const char *event, int evt, unsigned nparams, const struct afb_data_x4 * const *params, const char *pattern);
...
struct afb_hook_evt_itf {
	...
	void (*hook_evt_push_before)(void *closure, const struct afb_hookid *hookid, const char *evt, int id, unsigned nparams, const struct afb_data_x4 * const *params);
	void (*hook_evt_push_after)(void *closure, const struct afb_hookid *hookid, const char *evt, int id, unsigned nparams, const struct afb_data_x4 * const *params, int result);
	void (*hook_evt_broadcast_before)(void *closure, const struct afb_hookid *hookid, const char *evt, int id, unsigned nparams, const struct afb_data_x4 * const *params);
	void (*hook_evt_broadcast_after)(void *closure, const struct afb_hookid *hookid, const char *evt, int id, unsigned nparams, const struct afb_data_x4 * const *params, int result);
...
extern void afb_hook_evt_push_before(const char *evt, int id, unsigned nparams, const struct afb_data_x4 * const *params);
extern int afb_hook_evt_push_after(const char *evt, int id, unsigned nparams, const struct afb_data_x4 * const *params, int result);
extern void afb_hook_evt_broadcast_before(const char *evt, int id, unsigned nparams, const struct afb_data_x4 * const *params);
extern int afb_hook_evt_broadcast_after(const char *evt, int id, unsigned nparams, const struct afb_data_x4 * const *params, int result);
