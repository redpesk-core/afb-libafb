...
int afb_evt_evtid_push(struct afb_evtid *evtid, struct json_object *object)
{
	...
	rc = afb_jobs_queue(PUSH_JOB_GROUP, 0, push_job_evtid, je);
	if (rc == 0)
		rc = 1;
	else {
